...
Elm.Draw.make = function (_elm) {
   ...
   var drawLine = F3(function (highlighted,
   _v0,
   desc) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var $ = A2($Math.findRemotePointsOnLine,
                 $Basics.toFloat(A2($Basics.max,
                 _v0._0,
                 _v0._1)),
                 desc),
                 start = $._0,
                 end = $._1;
                 return $Graphics$Collage.traced(function () {
                    var style = $Graphics$Collage.solid($Color.blue);
   ...
   var drawCircle = F2(function (highlighted,
   _v4) {
      return function () {
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: _v4.center.x
                                       ,_1: _v4.center.y})($Graphics$Collage.outlined(function () {
            var style = $Graphics$Collage.solid($Color.green);
            return _U.replace([["width"
                               ,highlighted ? 4 : 2]],
            style);
         }())($Graphics$Collage.circle(_v4.radius)));
      }();
   });
   var drawGeoObject = F2(function (m,
   geo) {
      return function () {
         var _v6 = geo.object;
         switch (_v6.ctor)
         {case "Circle":
            return function () {
                 var _v11 = _v6._0.desc;
                 switch (_v11.ctor)
                 {case "Just":
                    return A2(drawCircle,
...
Elm.Main.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm);
   var intersectButtonClick = _P.portIn("intersectButtonClick",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple0"} : _U.badPort("an array",
      v);
   }));
   var deleteButtonClick = _P.portIn("deleteButtonClick",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple0"} : _U.badPort("an array",
      v);
   }));
   var circleButtonClick = _P.portIn("circleButtonClick",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple0"} : _U.badPort("an array",
      v);
   }));
   var lineButtonClick = _P.portIn("lineButtonClick",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple0"} : _U.badPort("an array",
      v);
   }));
   var modeSignal = $Signal.mergeMany(_L.fromArray([$Signal.constant($Types.DefaultMode)
                                                   ,A2($Signal.map,
                                                   $Basics.always($Types.DrawLine0),
                                                   lineButtonClick)
                                                   ,A2($Signal.map,
                                                   $Basics.always($Types.DrawCircle0),
                                                   circleButtonClick)
                                                   ,A2($Signal.map,
                                                   $Basics.always($Types.Delete),
                                                   deleteButtonClick)
                                                   ,A2($Signal.map,
                                                   $Basics.always($Types.Intersect0),
                                                   intersectButtonClick)]));
   var main = A2($Signal._op["<~"],
   $Draw.view,
   A3($Signal.foldp,
   $Model.update,
   $Model.emptyModel,
   $Signal.mergeMany(_L.fromArray([A2($Signal._op["~"],
                                  A2($Signal._op["<~"],
                                  $Types.MouseEvent,
                                  $Mouse.position),
                                  $Mouse.isDown)
...
Elm.Math.make = function (_elm) {
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Types = Elm.Types.make(_elm);
   var getSign = function (whichOne) {
      return function () {
         switch (whichOne.ctor)
   ...
   line2) {
      return function () {
         var determinant = A2(dot,
         rotate90(line1.normal),
         line2.normal);
         return _U.eq(determinant,
         0) ? $Maybe.Nothing : $Maybe.Just({_: {}
                                           ,x: (line1.offset * line2.normal.y - line1.normal.y * line2.offset) / determinant
                                           ,y: (line1.normal.x * line2.offset - line1.offset * line2.normal.x) / determinant});
      }();
   });
   var chooseCloserPointLC = F5(function (m,
   ld,
   cd,
   closePoint,
   inter) {
      return _U.cmp(A2(dot,
      rotate90(ld.normal),
      closePoint),
      A2(dot,
      rotate90(ld.normal),
      cd.center)) < 0 ? _U.insert("whichOne",
      $Types.NegativeOne,
      inter) : _U.insert("whichOne",
      $Types.PositiveOne,
      inter);
   });
   var times = F2(function (number,
   _v5) {
      return function () {
         return {_: {}
                ,x: number * _v5.x
   ...
   var minus = F2(function (p1,
   p2) {
      return {_: {}
             ,x: p1.x - p2.x
             ,y: p1.y - p2.y};
   });
   var pointsToLineDescription = F2(function (p,
   q) {
      return function () {
         var diff = A2(minus,q,p);
         var normal = normalize(rotate90(diff));
         return _U.eq(diff,
         {_: {}
         ,x: 0
         ,y: 0}) ? $Maybe.Nothing : $Maybe.Just({_: {}
                                                ,normal: normal
                                                ,offset: A2(dot,p,normal)});
      }();
   });
   var pointsToCircleDescription = F2(function (p,
   q) {
      return function () {
         var radius = norm(A2(minus,
         p,
         q));
         return _U.eq(radius,
         0) ? $Maybe.Nothing : $Maybe.Just({_: {}
   ...
   inter) {
      return function () {
         var centerVector = A2(minus,
         c2.center,
         c1.center);
         return _U.cmp(A2(dot,
         rotate90(centerVector),
         A2(minus,closePoint,c1.center)),
         0) < 0 ? _U.insert("whichOne",
         $Types.NegativeOne,
         inter) : _U.insert("whichOne",
         $Types.PositiveOne,
         inter);
   ...
   var lineCircleIntersection = F3(function (whichOne,
   line,
   circle) {
      return function () {
         var centerDistance = line.offset - A2(dot,
         circle.center,
         line.normal);
         var centerToProjection = A2(times,
         centerDistance,
         line.normal);
         var projectionOfCenter = A2(plus,
         centerToProjection,
         circle.center);
         var sign = getSign(whichOne);
         return _U.cmp($Basics.abs(centerDistance),
         circle.radius) > 0 ? $Maybe.Nothing : function () {
            var projectionToIntersectionDistance = $Basics.sqrt(Math.pow(circle.radius,
            2) - Math.pow(centerDistance,
            2));
            return $Maybe.Just(A2(plus,
            projectionOfCenter,
            A2(times,
            projectionToIntersectionDistance * sign,
            rotate90(line.normal))));
         }();
      }();
   });
   var circleCircleIntersection = F3(function (whichOne,
   circle1,
   circle2) {
      return _U.eq(circle1.center,
      circle2.center) ? $Maybe.Nothing : function () {
         var centerVector = A2(minus,
         circle2.center,
         circle1.center);
         var normalizedCenterVector = normalize(centerVector);
         var distance = norm(centerVector);
         var commonSecantMiddleDistanceFromCircle1 = (Math.pow(circle1.radius,
         2) - Math.pow(circle2.radius,
         2) + Math.pow(distance,
         2)) / (2 * distance);
         var commonSecantMiddle = A2(plus,
         A2(times,
         commonSecantMiddleDistanceFromCircle1,
         normalizedCenterVector),
         circle1.center);
         var intersectionOffsetSquare = Math.pow(circle1.radius,
         2) - Math.pow(commonSecantMiddleDistanceFromCircle1,
         2);
         var sign = getSign(whichOne);
         return _U.cmp(intersectionOffsetSquare,
         0) < 0 ? $Maybe.Nothing : function () {
            var intersectionOffset = sign * $Basics.sqrt(intersectionOffsetSquare);
            return $Maybe.Just(A2(plus,
            commonSecantMiddle,
            A2(times,
            intersectionOffset,
            rotate90(normalizedCenterVector))));
         }();
      }();
   });
   _elm.Math.values = {_op: _op
                      ...
                      ,chooseCloserPointLC: chooseCloserPointLC
                      ,chooseCloserPointCC: chooseCloserPointCC};
   return _elm.Math.values;
};
Elm.Maybe = Elm.Maybe || {};
...
Elm.Model.make = function (_elm) {
   ...
   var emptyModel = {_: {}
                    ...
                    ,newID: 0
                    ,objects: $Dict.empty};
   var transformMouseCoords = F2(function (_v0,
   _v1) {
      return function () {
         switch (_v1.ctor)
         {case "_Tuple2":
   ...
   var removeRevDep = F3(function (what,
   wher,
   m) {
      return function () {
         var removeDep = function (geo) {
            return _U.replace([["revDeps"
                               ,A2($Set.remove,
                               what,
                               geo.revDeps)]],
            geo);
   ...
   var removeRevDeps = F2(function (what,
   m) {
   ...
   var deleteObject = F2(function (id,
   model) {
      return function () {
         var objects$ = A2($Dict.remove,
         id,
         model.objects);
         var model$ = A2(removeRevDeps,
         id,
         _U.replace([["objects"
                     ,objects$]],
         model));
         var obj = $Types.fromJust(A2($Dict.get,
         id,
         model.objects));
         return A3($Set.foldr,
         deleteObject,
   ...
   var addRevDep = F3(function (what,
   wher,
   m) {
      return function () {
         var addDep = function (geo) {
            return _U.replace([["revDeps"
                               ,A2($Set.insert,
                               what,
                               geo.revDeps)]],
   ...
   var computeCircleDescription = F3(function (m,
   p1,
   p2) {
      return A2($Maybe.andThen,
      A2($Dict.get,p1,m.objects),
      function (point1) {
         return A2($Maybe.andThen,
         A2($Dict.get,p2,m.objects),
         function (point2) {
            return A2($Maybe.andThen,
            function () {
            ...
            function (x) {
               ...
               function (y) {
                  return A2($Math.pointsToCircleDescription,
                  x,
                  y);
               });
            });
   ...
   var circleObject = F4(function (id,
   center,
   edgePoint,
   desc) {
      return {_: {}
             ,deps: $Set.fromList(_L.fromArray([center
                                               ,edgePoint]))
             ,id: id
             ,name: A2($Basics._op["++"],
             "c",
             $Basics.toString(id))
             ,object: $Types.Circle({_: {}
                                    ,center: center
                                    ,desc: desc
                                    ,edgePoint: edgePoint})
             ,revDeps: $Set.empty};
   });
   var newCircle = F3(function (center,
   edgePoint,
   m) {
      return function () {
         var desc = A3(computeCircleDescription,
         m,
         center,
         edgePoint);
         var id = m.newID;
   ...
   var straightLine = F4(function (id,
   p1,
   p2,
   desc) {
      return {_: {}
             ,deps: $Set.fromList(_L.fromArray([p1
                                               ,p2]))
             ,id: id
             ,name: A2($Basics._op["++"],
             "l",
             $Basics.toString(id))
             ,object: $Types.Straight({_: {}
                                      ,desc: desc
                                      ,first: p1
                                      ,second: p2})
             ,revDeps: $Set.empty};
   });
   var computeLineDescription = F3(function (m,
   p1,
   p2) {
      return A2($Maybe.andThen,
      A2($Dict.get,p1,m.objects),
      function (point1) {
         ...
         function (point2) {
            ...
            function (x) {
               ...
               function (y) {
                  return A2($Math.pointsToLineDescription,
                  x,
                  y);
               });
            });
   ...
   var newStraightLine = F3(function (p1,
   p2,
   m) {
      return function () {
         var desc = A3(computeLineDescription,
         m,
         p1,
         p2);
         var id = m.newID;
         ...
         p1)(A2(addRevDep,
         id,
         p2)(_U.replace([["objects"
                         ,A3($Dict.insert,
                         m.newID,
                         A4(straightLine,id,p1,p2,desc),
                         m.objects)]
                        ,["newID",id + 1]],
         m)));
      }();
   });
   var intersectPoint = F3(function (id,
   inter,
   v) {
      return {_: {}
             ,deps: $Set.fromList(_L.fromArray([inter.first
                                               ,inter.second]))
             ,id: id
             ,name: A2($Basics._op["++"],
             "S",
             $Basics.toString(id))
             ,object: $Types.Intersect({_: {}
                                       ,intersection: inter
                                       ,point: v})
             ,revDeps: $Set.empty};
   });
   var computeIntersection = F2(function (model,
   inter) {
      return A2($Maybe.andThen,
      A2($Dict.get,
      inter.first,
   ...
   var recomputeObject = F2(function (model,
   obj) {
      return function () {
         switch (obj.ctor)
         {case "Circle":
            return $Types.Circle({_: {}
                                 ,center: obj._0.center
                                 ,desc: A3(computeCircleDescription,
                                 model,
                                 obj._0.center,
                                 obj._0.edgePoint)
                                 ,edgePoint: obj._0.edgePoint});
            case "FreePoint":
            return $Types.FreePoint(obj._0);
            case "Intersect":
            return $Types.Intersect({_: {}
                                    ,intersection: obj._0.intersection
                                    ,point: A2(computeIntersection,
                                    model,
                                    obj._0.intersection)});
            case "Straight":
            return $Types.Straight({_: {}
                                   ,desc: A3(computeLineDescription,
                                   model,
                                   obj._0.first,
                                   obj._0.second)
                                   ,first: obj._0.first
                                   ,second: obj._0.second});}
         _U.badCase($moduleName,
         "between lines 115 and 119");
      }();
   });
   var recomputeGeoObject = F2(function (model,
   geo) {
   ...
   var updateRevDeps = F2(function (id,
   model) {
      return function () {
         var objects$ = A3($Dict.update,
         id,
         $Maybe.map(recomputeGeoObject(model)),
         model.objects);
         var model$ = _U.replace([["objects"
                                  ,objects$]],
         model);
         var obj = $Types.fromJust(A2($Dict.get,
         id,
   ...
   var processDrag = F3(function (from,
   to,
   m) {
      return function () {
         var _v86 = m.mode;
   ...
   var newIntersection = F4(function (id1,
   id2,
   closePoint,
   m) {
      return function () {
         var id = m.newID;
         var obj2 = $Types.fromJust(A2($Dict.get,
         id2,
         m.objects));
         var obj1 = $Types.fromJust(A2($Dict.get,
         id1,
         m.objects));
         var inter = function () {
                    ...
                    switch (_v90._1.ctor)
                      {case "Circle":
                         ...
                         case "Straight": return {_: {}
                                                 ,first: id1
                                                 ,second: id2
                                                 ,whichOne: $Types.PositiveOne};}
                      break;}
                 break;}
            _U.badCase($moduleName,
            "between lines 34 and 39");
         }();
         var v = A2(computeIntersection,
         m,
         inter);
         return A2(addRevDep,
         id,
         inter.first)(A2(addRevDep,
         id,
         inter.second)(_U.replace([["objects"
                                   ,A3($Dict.insert,
                                   m.newID,
                                   A3(intersectPoint,id,inter,v),
                                   m.objects)]
                                  ,["newID",id + 1]],
         m)));
      }();
   });
   var freePoint = F2(function (id,
   v) {
      return {_: {}
             ,deps: $Set.empty
             ,id: id
             ...
             "P",
             $Basics.toString(id))
             ,object: $Types.FreePoint(v)
             ,revDeps: $Set.empty};
   });
   var newFreePoint = F2(function (v,
   m) {
      return function () {
         var id = m.newID;
         return _U.replace([["objects"
                              ...
                              {case false: switch (_v133._1)
                                   {case false:
                                      return A3(processMove,
                                        m.mousePosition,
                                        pos,
                                        _U.replace([["mouseDragged"
                                                    ,false]
                                                   ,["mousePosition",pos]],
                                        m));
                                      case true:
                                      return A2(processMouseDown,
                                        pos,
                                        _U.replace([["mouseDown",true]
                                                   ,["mouseDragged",false]],
                                        m));}
                                   break;
   ...
   _elm.Model.values = {_op: _op
                       ,newFreePoint: newFreePoint
                       ,freePoint: freePoint
                       ,newIntersection: newIntersection
                       ,computeIntersection: computeIntersection
                       ,intersectPoint: intersectPoint
                       ,newStraightLine: newStraightLine
                       ,computeLineDescription: computeLineDescription
                       ,straightLine: straightLine
                       ,newCircle: newCircle
                       ,circleObject: circleObject
                       ,computeCircleDescription: computeCircleDescription
                       ,recomputeObject: recomputeObject
                       ,recomputeGeoObject: recomputeGeoObject
                       ,updateRevDeps: updateRevDeps
                       ,addRevDep: addRevDep
                       ,removeRevDep: removeRevDep
                       ,removeRevDeps: removeRevDeps
                       ,deleteObject: deleteObject
                       ,update: update
                       ,processMouseDown: processMouseDown
                       ,processDrag: processDrag
                       ,processMove: processMove
                       ,processEndDrag: processEndDrag
...
Elm.Types.make = function (_elm) {
   ...
   var Intersect0 = {ctor: "Intersect0"};
   var DrawCircle1 = function (a) {
      return {ctor: "DrawCircle1"
             ,_0: a};
   };
   var DrawCircle0 = {ctor: "DrawCircle0"};
   var DrawLine1 = function (a) {
      return {ctor: "DrawLine1"
             ,_0: a};
   };
   var DrawLine0 = {ctor: "DrawLine0"};
   var Selected = function (a) {
      return {ctor: "Selected"
             ,_0: a};
   };
   var DefaultMode = {ctor: "DefaultMode"};
   ...
   var NegativeOne = {ctor: "NegativeOne"};
   var PositiveOne = {ctor: "PositiveOne"};
   var Intersection = F3(function (a,
   b,
   c) {
      return {_: {}
             ,first: a
   ...
   var LineDescription = F2(function (a,
   b) {
      return {_: {}
             ,normal: b
             ,offset: a};
   });
   var CircleDescription = F2(function (a,
   b) {
      return {_: {}
             ,center: a
             ,radius: b};
   ...
   var Straight = function (a) {
      return {ctor: "Straight"
             ,_0: a};
   };
   var Intersect = function (a) {
      return {ctor: "Intersect"
             ,_0: a};
   };
   var FreePoint = function (a) {
      return {ctor: "FreePoint"
             ,_0: a};
   };
   var GeoObject = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   _elm.Types.values = {_op: _op
                       ...
                       ,DrawLine0: DrawLine0
                       ,DrawLine1: DrawLine1
                       ,DrawCircle0: DrawCircle0
                       ,DrawCircle1: DrawCircle1
                       ,Intersect0: Intersect0
